...
Dependency:addModule(ElementType.Table, { ElementType.Rectangle, ElementType.Text, ElementType.IconButton, ElementType.Pagination, ElementType.Popover, ElementType.Skeleton, ElementType.Checkbox })
